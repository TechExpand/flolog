...
class AutoCompleteTextSearchField extends StatefulWidget {
  ...
  @override
  _AutoCompleteTextSearchFieldState createState() =>
      _AutoCompleteTextSearchFieldState();
}

class _AutoCompleteTextSearchFieldState
    extends State<AutoCompleteTextSearchField> {
  ...
  void _startFiltering(String val) {
    List<String> filter = widget.suggestions!
        .where((element) => _equalsIgnoreCase(element, val))
        .toList();
    print(filter);
